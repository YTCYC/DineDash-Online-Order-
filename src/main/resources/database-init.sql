DROP TABLE IF EXISTS order_items; --如果已经有这个名字的table存在了 那么删掉
...
-- we use Spring built in functionality to initialize the database
...
CREATE TABLE carts
(
    id          SERIAL PRIMARY KEY NOT NULL, -- SERIAL:auto increment 不需要程序员来定义

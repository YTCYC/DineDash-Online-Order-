...
public class AppConfig {
    ...
    @Bean
        // this annotation is a sign that function defined here is to return dependency
    UserDetailsManager users(DataSource dataSource) {
        // function returns dependency that's not defined by user
    ...
    PasswordEncoder passwordEncoder() {
        // server in general does not store passcode
        // PasswordEncoder is used for encode passcode and store it in database
        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .anyRequest().authenticated() // this one must be at the end this means those are not public
                )
                .exceptionHandling()
